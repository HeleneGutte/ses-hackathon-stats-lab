...
<mark>**Exercise 3: Calculate the corrleation between bill length and bill depth for the other two species. Remember to check for normality of both variables, if one of them is not normally distributed you have to choose another test (just google for non-parametric correlation test). **</mark>
