...
We want to use the palmer penguins data to show how to answer some common questions, applied in a SES context as outlined in the book "The Routledge handbook of research emthods fpr social-ecological systems [@biggs2021routledge] (even though this is a solely ecological data set, the concepts can be transferred to the SES context).  
...
The plot suggests that we can deny the Nullhypothesis, but we will verify this applying a regression model to the data. <br>
...
(i) think about possible explanations for the outliers. Did something unregular happened during the data sampling or processing of the samples in the lab? <br>
